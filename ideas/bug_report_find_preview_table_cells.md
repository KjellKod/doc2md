...
When the user opens an `.xlsx` or `.csv` file (or any source that converts to a markdown table, including other documents that has markdown tables inside of them) and toggles to **Preview** mode:
