...
| active | `mac-commercial-distribution-and-licensing` | Phase 7 research and decision record for `doc2md.dev`, direct DMG distribution, merchant-of-record licensing, and honest-user reminder licensing. See [research](../docs/implementation/mac-commercial-distribution-and-licensing.md). |
