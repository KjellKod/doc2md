...
| 6. Editor and UI Refresh (cross-surface) | active | Phase 6a PR #86; Phase 6c PR #87 (`save-control-ui_2026-04-27__1212`) | Hosted-web + Mac editor polish: app icon, persistent mode switcher, explicit save control, find/replace, accessibility audit, keyboard-shortcut help. Runs in parallel with Phase 5b+ because it does not touch the Mac shell contract. | MVP polish |
