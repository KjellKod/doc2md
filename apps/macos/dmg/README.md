...
`doc2md-dmg-background.png` is the committed Finder-window background for the Mac drag-install DMG.
...
- Source boundary: keep this file under `apps/macos/dmg/`, outside `apps/macos/doc2md/Resources/` and outside the Xcode target. It is copied into the temporary DMG staging tree only and must not be bundled into `doc2md.app/Contents/Resources/`.
