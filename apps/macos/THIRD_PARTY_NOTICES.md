...
| --- | ---: | --- | --- |
| `@asamuzakjp/css-color` | 5.1.11 | MIT | git+https://github.com/asamuzaK/cssColor.git |
| `@asamuzakjp/dom-selector` | 7.1.1 | MIT | git+https://github.com/asamuzaK/domSelector.git |
| `@asamuzakjp/generational-cache` | 1.0.1 | MIT | git+https://github.com/asamuzaK/generationalCache.git |
| `@asamuzakjp/nwsapi` | 2.3.9 | MIT | git://github.com/dperini/nwsapi.git |
| `@bramus/specificity` | 2.4.2 | MIT | git+https://github.com/bramus/specificity.git |
| `@csstools/color-helpers` | 6.0.2 | MIT-0 | git+https://github.com/csstools/postcss-plugins.git |
| `@csstools/css-calc` | 3.2.0 | MIT | git+https://github.com/csstools/postcss-plugins.git |
| `@csstools/css-color-parser` | 4.1.0 | MIT | git+https://github.com/csstools/postcss-plugins.git |
| `@csstools/css-parser-algorithms` | 4.0.0 | MIT | git+https://github.com/csstools/postcss-plugins.git |
| `@csstools/css-syntax-patches-for-csstree` | 1.1.3 | MIT-0 | git+https://github.com/csstools/postcss-plugins.git |
| `@csstools/css-tokenizer` | 4.0.0 | MIT | git+https://github.com/csstools/postcss-plugins.git |
| `@doc2md/core` | 1.0.1 | MIT | git+https://github.com/KjellKod/doc2md.git |
| `@exodus/bytes` | 1.15.0 | MIT | git+https://github.com/ExodusOSS/bytes.git |
...
| `jsdom` | 29.1.1 | MIT | git+https://github.com/jsdom/jsdom.git |
...
| `lru-cache` | 11.3.6 | BlueOak-1.0.0 | git+ssh://git@github.com/isaacs/node-lru-cache.git |
| `lucide-react` | 1.16.0 | ISC | https://github.com/lucide-icons/lucide.git |
...
| `tldts-core` | 7.0.30 | MIT | git+ssh://git@github.com/remusao/tldts.git |
| `tldts` | 7.0.30 | MIT | git+ssh://git@github.com/remusao/tldts.git |
