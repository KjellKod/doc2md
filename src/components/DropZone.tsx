  ...
  return (
    <div
      ...
      onClick={(event) => {
        ...
        // its own click behavior, such as the inline "browse" button.
        // Those elements either handle the click themselves or stop
        // propagation, so this `.closest()` check covers anything that
