...
export function createPendingEntry(file: File, index: number, selected: boolean): FileEntry {
...
export function getConversionFailureWarning(error: unknown, timeoutError: Error) {
