...
The current mixed-license model applies to Covered Software in releases tagged `2.2.0` and later, until a later release states a different license boundary in its release notes and license files.
