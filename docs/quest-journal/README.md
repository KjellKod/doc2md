...
| Date | Quest | Outcome |
|------|-------|---------|
| 2026-04-12 | [document-url-support](document-url-support_2026-04-12.md) | ```text Extend doc2md so document URLs work across both product surfaces, with full testing. |
