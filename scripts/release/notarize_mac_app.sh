...
write_notary_key() {
  ...
  # Strip whitespace and stray quotes a base64 secret can carry before
  # decoding; none are valid base64 (see sign_mac_app.sh decode_base64_secret).
  # \047 is octal for a single quote.
